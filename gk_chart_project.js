  ...
  pieChart(chart, chartID) {
    try {
      ...
      for (var i = 0; i < chart.data[0].datapoints.length; i++)
        pieChartDataDisplay += '<li><span style="width:20px; height: 10px; display: inline-block; margin-right: 10px; background-color:' + chart.data[0].datapoints[i].color + '"></span><span>' + chart.data[0].datapoints[i].label + ' : ' + chart.data[0].datapoints[i].y + '</span></li>'
