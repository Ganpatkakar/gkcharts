    ...
    _createClass(chartCalling, [
        {
            ...
            value: function lineChart(chart, chartID) {
                try {
                    ...
                    if (chart.config.printEnable == true) {
                        document
            ...
            value: function pieChart(chart, chartID) {
                try {
                    ...
                    var pieChartDataDisplay =
                        '<ul style="list-style: none; position:absolute; right: 0; width:' +
                        chart.wid * 1 / 2 +
                        'px; padding: 0px">';
                    for (var i = 0; i < chart.data[0].datapoints.length; i++) {
                        pieChartDataDisplay +=
                            '<li><span style="width:20px; height: 10px; display: inline-block; margin-right: 10px; background-color:' +
